...
<aside>
  <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="height: 79vh; width: 250px; position: fixed; margin-top: 26px;">
    ...
    <div class="dropdown">
      ...
      <?php if ($imagen_perfil): ?>
        <img src="data:image/jpeg;base64,<?= base64_encode($imagen_perfil) ?>" alt="" width="32" height="32" class="rounded-circle me-2">
        <?php else: ?>
